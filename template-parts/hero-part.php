...
<section 
  class="relative w-full h-[85vh] bg-cover bg-center rounded-xl p-8 md:p-12 my-8 mt-24"
...
>
  ...
  <div class="absolute bottom-0 left-0 right-0 z-10 p-8 md:p-12">
    <div class="max-w-7xl mx-auto">
      ...
      <form action="/search" method="get" class="glass-effect w-full max-w-2xl flex items-center rounded-lg p-1">
        <div class="flex-grow flex items-center">
          ...
          <input 
            type="text" 
            name="s"
            class="search-input w-full px-4 py-3 text-white placeholder-white/60 text-base"
            placeholder="<?php echo $search_group['search_placeholder']; ?>"
          >
        </div>
        <button 
          type="submit"
          class="px-8 py-3 bg-[#12A212]/90 hover:bg-[#12A212] text-white font-medium rounded-md transition-all duration-200"
        >
