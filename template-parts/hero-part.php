...
<div class="bg-[#1A1A1A] w-full">
  ...
  <div class="container mx-auto px-4">
    ...
    >
      ...
      <div class="relative z-10 h-full py-16 flex flex-col justify-center">
