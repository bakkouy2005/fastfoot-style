...
<section 
  class="relative w-full h-[85vh] bg-cover bg-center rounded-lg p-8 md:p-12 my-8" 
  ...
  <div class="absolute bottom-0 left-0 right-0 z-10 p-8 md:p-12">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="max-w-5xl mb-8">
        ...
        <p class="text-3xl md:text-7xl font-bold text-white/90 mb-8 text-start leading-tight">
