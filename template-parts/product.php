...
<?php if ($query->found_posts > $per_page): ?>
  <div class="text-center mt-12">
    <button 
      class="view-more-btn inline-flex items-center justify-center px-8 py-3 border border-white text-base bg-[#4b694b] rounded-[12px] border-none text-white font-medium hover:bg-white hover:text-black transition-colors"
