...
<div class=" min-h-screen text-white">
  ...
  <div class="flex flex-wrap gap-3">
    <label class="cursor-pointer">
      ...
      <div class="px-4 h-[44px] flex items-center justify-center bg-[#1A221A] text-white text-[14px] leading-[21px] font-medium border border-[#3D543D] rounded-[12px] peer-checked:border-white peer-checked:bg-[#1f2b1f] transition-all">
        No badge
      </div>
    </label>
