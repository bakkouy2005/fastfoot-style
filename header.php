...
<header class="site-header fixed w-full top-0 z-50">
    <div class="container mx-auto flex justify-between items-center py-4 px-4">
        ...
        <a href="<?php echo esc_url(home_url('/')); ?>" class="flex items-center relative z-10">
            <img src="<?php echo get_template_directory_uri(); ?>/images/image copy 2.png" alt="Fast Foot Style" class="h-16 md:h-14 w-auto <?php echo is_singular('product') ? 'product-page-logo' : 'h-22 md:h-20'; ?>">
        </a>
